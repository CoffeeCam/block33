...
const {
  updateRoutineActivity, canEditRoutineActivity, destroyRoutineActivity, getRoutineActivityById, getAllRoutineActivities,
} = require("../db");
const client = require("../db/client");
const { requireUser, requiredNotSent } = require("./utils");

//GET request /api/routine_activities
...
router.delete("/:routineActivityId", requireUser, async (req, res, next) => {
  try {
    ...
    } else {const deletedRoutineActivity = await destroyRoutineActivity(req.params.routineActivityId)
